...
// include"./node_modules/cricomlib/circuits/escalarmulifx.circom";

// template elGamalCheck(){
//     // public inputs of ciphertext parameters;
//     signal input C1x;
//     signal input C2x;
//     signal input C1y;
//     signal input C2y;
...
//     // private inputs parameter
//     signal input r; // random generator
//     signal input m; // which is the token weight;

//     // compute if the ciphertext are correct;
//        // Compute r*G (private)

//      component rG=FixedBaseMul();
//      rG.scalar <== r;
//     signal Rx = rG.OutX;
//     signal Ry = rG.OutY;
...
//     rPk.Py<==PKy;
//      rPK.scalar <== r;
//     signal rPKx = rPK.OutX;
//     signal rPKy = rPK.OutY;

//      // compute M = m*G using fixed-base multipler (public m)

//      component mG=FixedBaseMul();
//      mG.scalar<==m;
